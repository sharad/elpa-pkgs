...
(defalias 'org-capture-plue-place-entry #'org-capture-place-entry)
(defalias 'org-capture-plue-place-table-line #'org-capture-place-table-line)
(defalias 'org-capture-plue-place-plain-text #'org-capture-place-plain-text)
(defalias 'org-capture-plue-place-item #'org-capture-place-item)
(defalias 'org-capture-place-log-note #'org-capture-plue-place-log-note)
...
(defun org-capture-plus-place-template (&optional inhibit-wconf-store)
...
*** set target improved
#+BEGIN_SRC emacs-lisp
(defun org-capture-plus-set-target-location (&optional target)
...
(defun org-capture-run (type target template &rest plist)
  ...
  (let* ((orig-buf   (current-buffer))
    ...
    (if (and (not (org-capture-get :target))
      ...
      (condition-case error
          (org-capture-plus-place-template (eq (cl-first (org-capture-get :target)))
                                          'function)
        ((error quit)
