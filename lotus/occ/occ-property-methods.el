...
;; [[file:occ-property-methods.org::*Incorrect Method getting confused with `file' org buffer than current-file property of task][Incorrect Method getting confused with `file' org buffer than current-file property of task:1]]
;;{{ file
...
;;}}

;; Incorrect Method getting confused with `file' org buffer than current-file property of task:1 ends here

;; Correct Method


;; [[file:occ-property-methods.org::*Correct Method][Correct Method:1]]
;;{{ currfile
(cl-defmethod occ-rankprop ((obj occ-obj-ctx-tsk)
                            (prop (eql currfile)))
  ;; file in which tsk aka org entry exists.
