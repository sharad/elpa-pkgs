...
*** Current File property of task
    #+begin_src emacs-lisp
      ...
      (cl-defmethod occ-rankprop ((obj occ-obj-ctx-tsk)
        ...
        (let ((tsk (occ-obj-tsk obj))
              (ctx (occ-obj-ctx obj)))
          (occ-debug "occ-rankprop-with: currfile begin")
          (occ-aggrigate-list-rank tsk-currfile (occ-get-property tsk prop) #'+
            (let* ((tsk-currfile (if tsk-currfile (file-truename tsk-currfile)))
              ...
              (if tsk-currfile
                  (progn
                    (occ-nodisplay "tsk %s tsk-currfile %s" (occ-format tsk 'capitalize) tsk-currfile)
                    (occ-nodisplay "tsk %s ctx-file %s"     (occ-format tsk 'capitalize) ctx-file))
      ...
      (cl-defmethod occ-get-property-value-from-ctx ((ctx occ-ctx)
                                                     (prop (eql currfile)))
        "Return occ compatible value of property PROPERTY from OCC-CTX OBJ."
        (occ-debug "calling occ-get-property-value-from-ctx(ctx occ-ctx)")
      ...
      (cl-defmethod occ-rankprop ((obj occ-obj-ctx-tsk)
        ...
        (let ((tsk (occ-obj-tsk obj))
          ...
          (occ-aggrigate-list-rank tsk-root (occ-get-property tsk prop) #'+
            (let* ((tsk-root (first (occ-get-property tsk prop)))
              ...
              (if tsk-root
                  (progn
                    (occ-nodisplay "tsk %s tsk-root: %s" (occ-format tsk 'capitalize) tsk-root)
                    (occ-nodisplay "tsk %s ctx-dir:  %s" (occ-format tsk 'capitalize) ctx-dir))
