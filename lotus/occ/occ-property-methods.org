...
*** Template property of task in short
    #+begin_src emacs-lisp :tangle no
      ...
      (cl-defmethod occ-obj-format-prop ((obj occ-obj-tsk)
        ...
        value)
      (cl-defmethod occ-obj-list-p ((prop (eql _template1_)))
        "Is the property _TEMPLATE1_ has VALUES in list, Method tell
         property represent list or not.")
      (cl-defmethod occ-obj-prop-to-org ((prop (eql _template1_))
                                         value)
      ...
      representation.")
      (cl-defmethod occ-obj-prop-from-org ((prop (eql _template1_))
                                           value)
      ...
      (cl-defmethod occ-obj-readprop-from-user ((obj occ-tsk)
                                            (prop (eql _template1_)))
        "Read value of list of elements if (occ-obj-list-p PROPERTY)
...
*** Template property of task
    #+begin_src emacs-lisp :tangle no
      ...
      (cl-defmethod occ-obj-format-prop ((obj occ-obj-tsk)
        ...
        "Return format printable value of property PROPERTY."
        value)
      (cl-defmethod occ-obj-list-p ((prop (eql _template2_)))
        "Is the property _TEMPLATE2_ has VALUES in list, Method tell
         property represent list or not."
        nil)
      
      (cl-defmethod occ-obj-prop-to-org ((prop (eql _template2_))
                                         value)
      ...
      (cl-defmethod occ-obj-prop-from-org ((prop (eql _template2_))
                                           value)
        "Return the Actual Object representation for property
      ...
      (cl-defmethod occ-do-checkout-prop ((obj occ-obj-tsk)
        ...
        (let* ((tsk        (occ-obj-tsk      obj))
             ...
             (if first-file
               ...
               (occ-message "occ-do-checkout-prop: %s value ruturned for prop %s" first-file prop))))
      ;;}}
      
    ...
    #+begin_src emacs-lisp
      ...
      (cl-defmethod occ-obj-rankprop ((obj occ-obj-ctx-tsk)
        ...
        (let ((tsk (occ-obj-tsk obj))
          ...
          (occ-aggrigate-list-rank tsk-root (occ-obj-get-property tsk prop) #'+
            (let* ((tsk-root (first (occ-obj-get-property tsk prop)))
      ...
      (cl-defmethod occ-do-checkout-prop ((obj occ-obj-tsk)
        ...
        (let* ((tsk       (occ-obj-tsk      obj))
          ...
          (if first-dir
              (find-file first-dir)
            (occ-message "occ-do-checkout-prop: %s value ruturned for prop %s" first-dir prop))))
      ;;}}
      
    #+end_src
