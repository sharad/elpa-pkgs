...
(custom-theme-set-faces
 ...
 '(powerline-active1 ((t (:background "DarkRed" :foreground "white" :box (:line-width 1 :style released-button)))))
 '(powerline-active2 ((t (:background "LightRed" :foreground "white" :box (:line-width 1 :style released-button)))))
 '(powerline-inactive1 ((t (:background "DarkGreen" :foreground "white" :inherit mode-line))))
 '(powerline-inactive2 ((t (:background "LightGreen" :foreground "white" :inherit mode-line))))
